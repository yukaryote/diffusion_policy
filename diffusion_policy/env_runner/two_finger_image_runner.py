...
from mujoco_sim.env.two_finger_env import TwoFingerEnvCfg
from diffusion_policy.env.two_finger.two_finger_gym_env_image import TwoFingerGoalEnvImage

class TwoFingerImageRunner(BaseImageRunner):
    def __init__(self,
            output_dir,
            state_type='qpos',
            n_train=1,
        ...
        def env_fn():
            return MultiStepWrapper(
                VideoRecordingWrapper(
                    TwoFingerGoalEnvImage(state_type=state_type, **env_kwargs),
