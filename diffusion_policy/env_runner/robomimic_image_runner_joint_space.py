...
from diffusion_policy.env.robomimic.env_robosuite_custom import EnvRobosuiteCustom
...
def create_env(env_meta, env_target, shape_meta, enable_render=True):
    env = EnvRobosuiteCustom(
...
class RobomimicImageRunnerJointSpace(BaseImageRunner):
    """
